...
func TestReactionHasBeenAdded(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveReactionsCount", handlers.ReactionSetAction, actionSourceMattermost, false).Times(1)
			},
		},
		{
...
func TestReactionHasBeenRemoved(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveReactionsCount", handlers.ReactionUnsetAction, actionSourceMattermost, false).Times(1)
			},
		},
		{
...
func TestMessageHasBeenUpdated(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveMessagesCount", handlers.ActionUpdated, actionSourceMattermost, true).Times(1)
			},
		},
		{
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveMessagesCount", handlers.ActionUpdated, actionSourceMattermost, false).Times(1)
			},
		},
		{
...
func TestSetChatReaction(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveReactionsCount", handlers.ReactionSetAction, actionSourceMattermost, true).Times(1)
			},
			UpdateRequired: true,
		},
		{
...
func TestUnsetChatReaction(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveReactionsCount", handlers.ReactionUnsetAction, actionSourceMattermost, true).Times(1)
			},
		},
		{
...
func TestDelete(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveMessagesCount", handlers.ActionDeleted, actionSourceMattermost, false).Times(1)
			},
		},
	} {
		t.Run(test.Name, func(t *testing.T) {
...
func TestDeleteChat(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			SetupMetrics: func(metrics *metricsmocks.Metrics) {
				metrics.On("ObserveMessagesCount", handlers.ActionDeleted, actionSourceMattermost, true).Times(1)
			},
		},
	} {
		t.Run(test.Name, func(t *testing.T) {
