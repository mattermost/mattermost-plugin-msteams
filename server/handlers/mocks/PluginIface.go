...
// CheckAndGetUsername provides a mock function with given fields: _a0, _a1, _a2
func (_m *PluginIface) CheckAndGetUsername(_a0 *model.AppError, _a1 string, _a2 int) string {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 string
	if rf, ok := ret.Get(0).(func(*model.AppError, string, int) string); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(string)
	}
