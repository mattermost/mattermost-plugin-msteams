	...
	for _, testCase := range []struct {
	...
	}{
		{
			...
			setupMetrics: func(metrics *mocksMetrics.Metrics) {
				metrics.On("ObserveFilesCount", actionCreated, actionSourceMSTeams, directMessageFalse, "", int64(increaseFileCountByOne)).Times(1)
			},
			attachments: []msteams.Attachment{
				{
					Name: "mock-name",
		...
		},
		{
			...
			setupMetrics: func(metrics *mocksMetrics.Metrics) {
				metrics.On("ObserveFilesCount", actionCreated, actionSourceMSTeams, directMessageFalse, discardedReasonEmptyFileID, int64(increaseFileCountByOne)).Times(1)
			},
			attachments: []msteams.Attachment{
				{
					Name: "mock-name",
		...
		},
		{
			...
			setupMetrics: func(metrics *mocksMetrics.Metrics) {
				metrics.On("ObserveFilesCount", actionCreated, actionSourceMSTeams, directMessageFalse, "", int64(increaseFileCountByOne)).Times(10)
				metrics.On("ObserveFilesCount", actionCreated, actionSourceMSTeams, directMessageFalse, discardedReasonFileLimitReached, int64(2)).Times(1)
			},
			attachments: []msteams.Attachment{
				{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},
			},
