...
func TestMessageHasBeenPostedNewMessage(t *testing.T) {
	...
	plugin.metricsService.(*metricsmocks.Metrics).On("ObserveMessagesCount", handlers.ActionCreated, handlers.ActionSourceMattermost, handlers.DirectMessageFalse).Times(1)
