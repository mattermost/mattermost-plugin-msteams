...
// RequestUserToken provides a mock function with given fields: message
func (_m *Client) RequestUserToken(message chan string) (oauth2.TokenSource, error) {
	ret := _m.Called(message)

	var r0 oauth2.TokenSource
	if rf, ok := ret.Get(0).(func(chan string) oauth2.TokenSource); ok {
		r0 = rf(message)
	} else {
		if ret.Get(0) != nil {
